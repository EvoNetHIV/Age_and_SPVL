...
plot(dd$onset[i1], pmin(dd$terminus[i1],366))
plot(dd$onset[i2], pmin(dd$terminus[i2],366))
plot(dd$onset[i3], pmin(dd$terminus[i3],366))

days_no_diss <- pmin(dd$terminus,366) - pmax(dd$onset,0) - 1
