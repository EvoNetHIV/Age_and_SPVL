...
OK, I have created a list of runs for Sarah which I will email to her now.  It is "_supporting_files/AgeSOVL runs master list.xlsx".   I've also created the first of the script files (m101).
...
To Do:
- try some runs with higher treatment levels (what is the incidence rate though?)
- add with higher relational formation rates for younger folks.
- but really ultimately we need John's code with dissolution rates differing by age for heteros: not sure i can do this befire Sunbelt though, and certainly not today.
