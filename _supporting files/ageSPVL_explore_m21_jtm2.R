...
evoparams$prob_tx_droput = .05
evoparams$tx_type="VL"
evoparams$tx_schedule_props=c(F=0,V=1,N=0,P=0)

evoparams$tx_type <- "random"
...
evoparams$start_treat_before_big_campaign = 365 # Start time of gradual ramp-up prior to the start of the big TasP campaign (this part random)
evoparams$start_treatment_campaign      = 2*365   # Start time of big TasP campaign (this part depends on tx_type)
