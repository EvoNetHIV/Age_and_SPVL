...
evoparams$tx_limit = "absolute_num"
...
evoparams$prob_tx_droput  = 0.1   # Probability of "V"-type agent discontinuing therapy over the course of a year
...
ageSPVL_m30 <- evomodel
save(ageSPVL_m30, file="ageSPVL_m30.rda")
